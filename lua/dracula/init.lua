...
M.apply = function()
	...
	highlight("TSText", colors.fg, nil, nil, nil)
	highlight("TSStrong", colors.fg, nil, "bold", nil)
	highlight("TSEmphasis", colors.fg, nil, "italic", nil)
	highlight("TSUnderline", colors.fg, nil, "underline", nil)
	highlight("TSTitle", colors.pink, nil, "bold", nil)
